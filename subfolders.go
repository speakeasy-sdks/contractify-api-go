...
func (s *subfolders) ListSubfolders(ctx context.Context, request operations.ListSubfoldersRequest, security operations.ListSubfoldersSecurity) (*operations.ListSubfoldersResponse, error) {
