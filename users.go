...
func (s *users) CurrentUser(ctx context.Context, security operations.CurrentUserSecurity) (*operations.CurrentUserResponse, error) {
...
func (s *users) ListUsers(ctx context.Context, request operations.ListUsersRequest, security operations.ListUsersSecurity) (*operations.ListUsersResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
